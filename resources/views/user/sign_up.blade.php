                            ...
                            <form action="{{ route('store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Membership Number"
                                            id="membership" name="nomor_keanggotaan">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="regional">Cabang</label>
                                        <input type="text" class="form-control" placeholder="Regional Branch"
                                            id="regional" name="cabang">
                                    </div>
                                    <div class="form-group col-md-6">
